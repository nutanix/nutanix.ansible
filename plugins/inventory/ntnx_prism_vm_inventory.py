...
class InventoryModule(BaseInventoryPlugin):
    ...
    def verify_file(self, path):
        ...
        inventory_file_fmts = ('nutanix.yaml', 'nutanix.yml',
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        module = Mock_Module(self.nutanix_hostname, self.nutanix_port,
                             self.nutanix_username, self.nutanix_password,
                             self.validate_certs)
        vm = vms.VM(module)
        resp, status_code = vm.list(self.data)
        keys_to_strip_from_resp = ["disk_list", "vnuma_config", "nic_list",
                                   "power_state_mechanism", "host_reference",
                                   "serial_port_list", "gpu_list",
                                   "storage_config", "boot_config",
                                   "guest_customization"]
