...
DOCUMENTATION = r"""
module: ntnx_restore_v2
short_description: Restore a domain manager (Prism Central) from a cluster or object store backup location based on the selected restore point.
version_added: 2.7.0
description:
...
notes:
    - This module talks to the Prism Element endpoint, set C(nutanix_host) to the Prism Element IP.
    - >-
