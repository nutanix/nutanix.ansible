...
def get_api_client(module):
    """
    Return an ntnx_aiops_py_client ApiClient configured from the standard
    Nutanix credential module parameters (host/port/user/password or api key).

    Args:
        module (AnsibleModule): the invoking Ansible module.

    Returns:
        ntnx_aiops_py_client.ApiClient: an authenticated aiops API client.
    """
    if SDK_IMP_ERROR:
        module.fail_json(
...
def get_etag(data):
    ...
    Args:
        data (object): the v4 SDK response.
...
def get_stats_api_instance(module):
    """
    Return an aiops StatsApi instance configured against the target PC.

    Args:
        module (AnsibleModule): the invoking Ansible module.

    Returns:
        ntnx_aiops_py_client.StatsApi: aiops Stats API instance.
    """
