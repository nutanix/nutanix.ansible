...
def get_licensing_api_instance(module):
    """
    This method will return LCM licensing API instance
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): v4 LCM licensing api instance
    """
    api_client = get_api_client(module)
    return ntnx_licensing_py_client.LicensesApi(api_client=api_client)
