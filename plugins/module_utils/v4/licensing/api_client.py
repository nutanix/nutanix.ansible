...
def get_licensing_key_api_instance(module):
    """
    This method will return licensing key api instance.
    Args:
        module (object): Ansible module object
    Returns:
        api_instance (object): licensing key api instance
    """
    client = get_api_client(module)
    return ntnx_licensing_py_client.LicenseKeysApi(client)
