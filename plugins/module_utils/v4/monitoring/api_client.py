...
def get_api_client(module):
    """
    Build and return the ntnx_monitoring_py_client ApiClient for a module.

    Args:
        module (object): Ansible module object providing connection parameters.

    Returns:
        client (object): Configured api client instance.
    """
    if SDK_IMP_ERROR:
        module.fail_json(
...
def get_cluster_logs_api_instance(module):
    """
    Return a ClusterLogsApi instance used to list Logbay tags and collect logs.
