...
def get_api_client(module):
    """
    This method will return a monitoring api client using given connection
    details from the module parameters.

    Args:
        module (object): Ansible module object
    Returns:
        client (object): ntnx_monitoring_py_client.ApiClient instance
    """
    if SDK_IMP_ERROR:
        module.fail_json(
...
def get_etag(data):
    ...
    Returns:
        etag (str): etag value or None if unavailable
    """
...
def get_system_defined_policies_api_instance(module):
    """
    Return a SystemDefinedPoliciesApi instance backed by the monitoring SDK.

    Args:
        module (object): Ansible module object
    Returns:
        api_instance (object): System-Defined Alert Policies api instance
    """
