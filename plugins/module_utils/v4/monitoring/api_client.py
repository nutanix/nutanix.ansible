...
def get_events_api_instance(module):
    """
    This method will return EventsApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): monitoring events api instance
    """
    api_client = get_api_client(module)
    return ntnx_monitoring_py_client.EventsApi(api_client=api_client)
