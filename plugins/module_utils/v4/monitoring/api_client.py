...
def get_audits_api_instance(module):
    """
    This method will return AuditsApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): Audits Api instance
    """
    api_client = get_api_client(module)
    return ntnx_monitoring_py_client.AuditsApi(api_client=api_client)
