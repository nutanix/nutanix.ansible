...
def get_alerts_api_instance(module):
    """
    This method will return AlertsApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): Alerts Api instance
    """
...
def get_manage_alerts_api_instance(module):
    """
    This method will return ManageAlertsApi instance used for
    acknowledging or resolving an alert.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): Manage Alerts Api instance
    """
    api_client = get_api_client(module)
