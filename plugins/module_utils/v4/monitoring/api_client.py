...
def get_alert_email_configuration_api_instance(module):
    """
    This method will return AlertEmailConfigurationApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): Alert Email Configuration Api instance
    """
    api_client = get_api_client(module)
    return ntnx_monitoring_py_client.AlertEmailConfigurationApi(api_client=api_client)
