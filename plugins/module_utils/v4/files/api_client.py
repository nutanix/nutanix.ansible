...
def get_recommendations_api_instance(module):
    """
    This method will return RecommendationsApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): Recommendations Api instance
    """
    api_client = get_api_client(module)
    return ntnx_files_py_client.RecommendationsApi(api_client=api_client)
