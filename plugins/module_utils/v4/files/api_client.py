...
def get_api_client(module):
    ...
    given connection details for the Nutanix Files namespace.
    Args:
...
def get_user_mappings_api_instance(module):
    """
    This method will return UserMappingsApi instance.
    Args:
        module (object): Ansible module object
    return:
        api_instance (object): User Mappings Api instance
    """
